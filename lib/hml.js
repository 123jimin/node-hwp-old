...
hml.LineType1 = ["Solid", "Dash", "Dot", "DashDot", "DashDotDot", "LongDash", "Circle", "DoubleSlim", "SlimThick", "ThickSlim", "SlimThickSlim", "None"];
...
hml.HML.prototype.findChild = function findChild(name){
	for(var i=0;i<this.child.length;i++){
		if(this.child[i].name === name) return this.child[i];
	}
	return null;
